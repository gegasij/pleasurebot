...
@Component(value = "lovelyBotListener")
public class TelegramBotUpdateListener {

    public TelegramBotUpdateListener(@Qualifier("lovelyBot") TelegramBot telegramBot, UpdateResolver updateResolver, TelegramBotApi telegramBotApi) {
